...
export default function LoginPage() {
    ...
    return (
        <div className="rounded-[18px] border border-white/70 bg-white/80 p-8 shadow-[0_1px_2px_rgba(20,49,42,0.04),0_16px_40px_-20px_rgba(20,49,42,0.22)] backdrop-blur-[14px]">
            <h1 className="mb-1 font-[var(--font-display)] text-2xl text-[var(--forest-900)]">Welcome back</h1>
            <p className="mb-6 text-sm text-stone-500">Sign in to your YieldAI account.</p>
