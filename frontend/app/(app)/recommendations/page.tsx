...
export default function RecommendationsPage() {
  ...
  useEffect(() => {
    // Refetching when the active farm's state/district changes is the
    // standard data-fetching-on-dependency pattern; setLoading(true) here
    // ensures the loading UI shows immediately on farm switch.
